        ...
        <div id='home' className='flex bg-hero-pattern flex-col bg-cover bg-center w-full relative justify-center items-center'>
            ...
            <div className="container mx-auto px-4">
                <div className="lg:pt-[197px] lg:pb-[168px] py-20">
                    ...
                    <CustomButton btnTitle='idea' title="Bring your idea to life!" customStyles="lg:max-w-[312px] max-lg:mx-auto max-lg:flex justify-center max-xl:relative max-xl:z-10 hover:relative hover:z-20 md:max-w-64 max-w-44 w-full lg:h-[67px]" />
                </div>
            </div>
