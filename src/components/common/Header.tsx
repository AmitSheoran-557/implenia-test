...
const Header = () => {
    ...
    return (
        <div className="bg-white mx-auto w-full flex justify-center items-center">
            <div className="flex justify-between items-center mx-auto w-full max-w-[1212px] px-4 rounded-[20px] overflow-hidden lg:py-[18px] py-4">
                ...
                <a href="/">
                    <img className="xl:max-w-[93px] lg:max-w-20 md:max-w-16 max-w-12 w-full" src="/assets/images/png/header-logo.png" alt="page-logo" />
                </a>
